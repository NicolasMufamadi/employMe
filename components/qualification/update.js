...
module.exports = (async(req,res)=> {
    ...
    try {
        ...
        db.query("UPDATE  qualifications SET user_id = ($1), qualification_status = ($2), institution_name = ($3), study_field = ($4), study_type = ($5), starting_date = ($6), ending_date = ($7) WHERE qualification_id = ($8) ",[
