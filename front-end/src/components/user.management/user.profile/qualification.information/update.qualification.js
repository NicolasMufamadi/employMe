...
export default function UpdateQualification(){
    ...
    useEffect(()=> {
       ...
       async function getQualification(){
            ...
            const request = await fetch(`${config.baseURL.endPoint}/qualification/${qualificationId}`);
          ...
          <div className="container">
            ...
            <div className="d-flex mb-3">
              ...
              <button
                ...
                onClick={()=> navigate('/myaccount/qualification-info/view-qualifications')}
              >
                View Qualifications
              </button>
            </div>
            <form>
              ...
              <div className="row mt-1">
                ...
                <div>
                  <input className="input col-6" defaultValue={qualification.institution_name} value={institution} onChange={(e)=> setInstitution(e.target.value)}/>
                  {
                    institutionErr ? (
              ...
              <div className="row">
                ...
                <div className="col-6">
                  <select className="form-select form-select-lg" value={faculty} onChange={(e)=> setFaculty(e.target.value)}>
              ...
              <div className="row mt-1">
                ...
                <div className="col">
                  <input className="input col-6" value={studyField} onChange={(e)=> setStudyField(e.target.value)} />
                  {
                    degreeErr ? (
                      <p className="text-danger">{degreeErr}</p>
                    ): <></>
                  }
                </div>
              </div>
            ...
            <div className="mt-3"></div>
              <div className="mb-5">
                <button className="btn submitBtn mb-5">Add New</button>
              </div>
