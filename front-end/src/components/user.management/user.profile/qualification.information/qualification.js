...
export default function QualificationInformation() {
 ...
 // const [qualifications,setQualifications] = useState([]);
  ...
  const add = async () =>{
    ...
    if(validate()){
      ...
      const request = await fetch('http://localhost:4444/qualification/',{
        method: 'POST',
      ...
      <div className="container">
        ...
        <form>
          ...
          <div className="row mt-1">
            ...
            <div>
              <input className="input col-6" value={institution} onChange={(e)=> setInstitution(e.target.value)}/>
              {
                institutionErr ? (
        ...
        <div className="mt-3"></div>
          <div className="mb-5">
            <button className="btn submitBtn mb-5" onClick={()=> add()}>Add New</button>
          </div>
